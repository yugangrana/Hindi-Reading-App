...
═══════════════════════════════════════════════════════ */
const LEVELS = [
  { id:"bv1", label:"बालवाटिका १", en:"Balvatika 1", age:"3–4 yrs", color:"#FF7043", bg:"#FBE9E7", icon:"🌱" },
  { id:"bv2", label:"बालवाटिका २", en:"Balvatika 2", age:"4–5 yrs", color:"#43A047", bg:"#E8F5E9", icon:"🌿" },
  { id:"bv3", label:"बालवाटिका ३", en:"Balvatika 3", age:"5–6 yrs", color:"#1E88E5", bg:"#E3F2FD", icon:"🌻" },
  { id:"c1",  label:"कक्षा १",     en:"Class 1",    age:"6–7 yrs", color:"#8E24AA", bg:"#F3E5F5", icon:"⭐" },
  { id:"c2",  label:"कक्षा २",     en:"Class 2",    age:"7–8 yrs", color:"#E53935", bg:"#FFEBEE", icon:"🏆" },
];

const SWAR = [
  {a:"अ",eg:"अनार",em:"🍎"},{a:"आ",eg:"आम",em:"🥭"},{a:"इ",eg:"इमली",em:"🌿"},
  {a:"ई",eg:"ईख",em:"🎋"},{a:"उ",eg:"उल्लू",em:"🦉"},{a:"ऊ",eg:"ऊन",em:"🧶"},
  {a:"ए",eg:"एड़ी",em:"🦶"},{a:"ऐ",eg:"ऐनक",em:"👓"},{a:"ओ",eg:"ओस",em:"💧"},
  {a:"औ",eg:"औजार",em:"🔧"},{a:"अं",eg:"अंगूर",em:"🍇"},{a:"अः",eg:"अंत",em:"🔚"},
];

const VYANJAN = [
  {a:"क",eg:"कमल",em:"🪷"},{a:"ख",eg:"खरगोश",em:"🐰"},{a:"ग",eg:"गाय",em:"🐄"},
  {a:"घ",eg:"घर",em:"🏠"},{a:"च",eg:"चाँद",em:"🌙"},{a:"छ",eg:"छाता",em:"☂️"},
  {a:"ज",eg:"जहाज",em:"✈️"},{a:"झ",eg:"झंडा",em:"🚩"},{a:"ट",eg:"टमाटर",em:"🍅"},
  {a:"ठ",eg:"ठंड",em:"❄️"},{a:"ड",eg:"डमरू",em:"🥁"},{a:"ढ",eg:"ढोल",em:"🪘"},
  {a:"त",eg:"तरबूज",em:"🍉"},{a:"थ",eg:"थाली",em:"🍽️"},{a:"द",eg:"दही",em:"🥛"},
  {a:"ध",eg:"धनुष",em:"🏹"},{a:"न",eg:"नल",em:"🚰"},{a:"प",eg:"पतंग",em:"🪁"},
  {a:"फ",eg:"फल",em:"🍊"},{a:"ब",eg:"बत्तख",em:"🦆"},{a:"भ",eg:"भालू",em:"🐻"},
  {a:"म",eg:"मछली",em:"🐟"},{a:"य",eg:"यान",em:"🚀"},{a:"र",eg:"रथ",em:"🎠"},
  {a:"ल",eg:"लड्डू",em:"🟡"},{a:"व",eg:"वर्षा",em:"🌧️"},{a:"श",eg:"शेर",em:"🦁"},
  {a:"स",eg:"सेब",em:"🍎"},{a:"ह",eg:"हाथी",em:"🐘"},
];

const MATRAS = [
  {sym:"ा",name:"आ की मात्रा",eg:"काम",color:"#FF7043"},
  {sym:"ि",name:"इ की मात्रा",eg:"किला",color:"#43A047"},
  {sym:"ी",name:"ई की मात्रा",eg:"नदी",color:"#1E88E5"},
  {sym:"ु",name:"उ की मात्रा",eg:"सुन",color:"#FB8C00"},
  {sym:"ू",name:"ऊ की मात्रा",eg:"भूल",color:"#8E24AA"},
  {sym:"े",name:"ए की मात्रा",eg:"देश",color:"#00897B"},
  {sym:"ै",name:"ऐ की मात्रा",eg:"पैसा",color:"#E53935"},
  {sym:"ो",name:"ओ की मात्रा",eg:"मोर",color:"#D81B60"},
  {sym:"ौ",name:"औ की मात्रा",eg:"पौधा",color:"#6D4C41"},
];

const WORDS = [
  {w:"कमल",m:"Lotus",em:"🪷"},{w:"नल",m:"Tap",em:"🚰"},{w:"घर",m:"Home",em:"🏠"},
  {w:"फल",m:"Fruit",em:"🍎"},{w:"जल",m:"Water",em:"💧"},{w:"मन",m:"Mind",em:"🧠"},
  {w:"पल",m:"Moment",em:"⏱️"},{w:"रथ",m:"Chariot",em:"🎠"},{w:"हल",m:"Plough",em:"⚒️"},
  {w:"कमरा",m:"Room",em:"🚪"},{w:"सड़क",m:"Road",em:"🛣️"},{w:"बगीचा",m:"Garden",em:"🌸"},
  {w:"पानी",m:"Water",em:"💧"},{w:"खाना",m:"Food",em:"🍛"},{w:"किताब",m:"Book",em:"📚"},
  {w:"बच्चा",m:"Child",em:"👶"},{w:"रोटी",m:"Bread",em:"🫓"},{w:"कपड़ा",m:"Cloth",em:"👕"},
  {w:"सेब",m:"Apple",em:"🍎"},{w:"गाय",m:"Cow",em:"🐄"},{w:"शेर",m:"Lion",em:"🦁"},
  {w:"हाथी",m:"Elephant",em:"🐘"},{w:"आम",m:"Mango",em:"🥭"},{w:"नमक",m:"Salt",em:"🧂"},
  {w:"दूध",m:"Milk",em:"🥛"},{w:"चाय",m:"Tea",em:"🍵"},{w:"चावल",m:"Rice",em:"🍚"},
  {w:"मछली",m:"Fish",em:"🐟"},{w:"फूल",m:"Flower",em:"🌸"},{w:"पत्ता",m:"Leaf",em:"🍃"},
];

const SENTENCES = [
  "राम खाना खाता है।","सीता पानी पीती है।","मोहन स्कूल जाता है।",
  "गाय घास खाती है।","बच्चे खेलते हैं।","माँ खाना बनाती है।",
  "पक्षी आकाश में उड़ते हैं।","सूरज सुबह उगता है।",
  "हाथी बड़ा जानवर है।","बिल्ली दूध पीती है।",
  "कुत्ता भौंकता है।","मछली पानी में रहती है।",
];

const STORY = `एक बार एक शेर और एक चूहा थे।\nशेर जंगल में सो रहा था।\nचूहा उसके ऊपर से कूद गया।\nशेर जाग गया और उसे पकड़ लिया।\nचूहे ने कहा — मुझे छोड़ दो।\nशेर हँसा और उसे जाने दिया।\nएक दिन शेर जाल में फँस गया।\nचूहे ने जाल काट दिया।\nशेर आज़ाद हो गया।\nदोस्ती बड़ी चीज़ है।`;

const LEADERBOARD_DATA = [
  {name:"प्रिया शर्मा",av:"👧",pts:1240,wpm:42,lvl:"Class 2",streak:7},
  {name:"अर्जुन सिंह", av:"👦",pts:1180,wpm:39,lvl:"Class 2",streak:5},
  {name:"मीरा पटेल",   av:"👧",pts:1050,wpm:35,lvl:"Class 1",streak:4},
  {name:"रोहन गुप्ता", av:"👦",pts:920, wpm:30,lvl:"Class 1",streak:3},
  {name:"आयशा खान",   av:"👧",pts:870, wpm:25,lvl:"BV 3",   streak:6},
  {name:"देव कुमार",   av:"👦",pts:760, wpm:22,lvl:"BV 3",   streak:2},
];

const BADGES = [
  {icon:"🌟",name:"पहला कदम",   desc:"First lesson done",     pts:50 },
  {icon:"📖",name:"पाठक",       desc:"10 lessons done",       pts:100},
  {icon:"⚡",name:"तेज़ पाठक",   desc:"Reached 30 WPM",       pts:150},
  {icon:"🔥",name:"7-Day Streak",desc:"7 days in a row",      pts:200},
  {icon:"🏅",name:"स्वर विद्वान",desc:"All Swar mastered",    pts:100},
  {icon:"👑",name:"शब्द राजा",   desc:"100 words practised",  pts:200},
  {icon:"🎤",name:"Voice Star",  desc:"10 voice matches",     pts:150},
  {icon:"♾️",name:"Endless Hero",desc:"50 endless questions", pts:300},
];

/* ═══════════════════════════════════════════════════════
   READING TEST DATA — 5 LEVELS, LARGE NON-REPEATING POOLS
═══════════════════════════════════════════════════════ */

// Level 1 — individual letters/syllables shown as a tap-grid
const RT_LV1_POOL = [
  "अ","आ","इ","ई","उ","ऊ","ए","ऐ","ओ","औ","अं","अः",
  "क","ख","ग","घ","च","छ","ज","झ","ट","ठ","ड","ढ",
  "त","थ","द","ध","न","प","फ","ब","भ","म","य","र",
  "ल","व","श","स","ह","ञ","ण","ङ","ष","क्ष","त्र","ज्ञ",
  "का","कि","की","कु","कू","के","को","कौ","कं",
  "मा","मि","मी","मु","मू","मे","मो","मौ","मं",
  "रा","रि","री","रु","रू","रे","रो","रौ","रं",
  "सा","सि","सी","सु","सू","से","सो","सौ","सं",
  "पा","पि","पी","पु","पू","पे","पो","पौ","पं",
  "नी","नि","ना","नु","नू","ने","नो","नौ","नं",
  "ता","ति","ती","तु","तू","ते","तो","तौ","तं",
  "बा","बि","बी","बु","बू","बे","बो","बौ","बं",
];

// Level 2 — 2-letter words without matras (large pool of 60+)
const RT_LV2_POOL = [
  "नल","घर","फल","जल","मन","पल","रथ","हल","गम","दम",
  "तन","धन","वन","मत","पद","कम","बस","दस","सब","तब",
  "जब","अब","पर","बल","कल","यह","वह","तक","रस","गण",
  "पग","जग","रन","चन","बन","सन","कन","जन","मर","गर",
  "हर","पर","डर","तर","बर","नर","सर","वर","धर","खर",
  "टब","डब","कप","नप","जप","तप","रप","मप","सट","पट",
  "मट","गट","दट","जट","नट","कट","रट","भट","दल","जल",
];

// Level 3 — 3-4 letter words with matras (large pool of 80+)
const RT_LV3_POOL = [
  "काम","आम","नाम","दाम","राम","जाम","धाम","ताम","पाम","खाम",
  "नीम","दीन","भीड़","चील","तीर","धीर","गीत","जीत","रीत","खीर",
  "कमल","नमक","पतंग","बगल","सफल","दमन","रमन","जगन","लखन","मगन",
  "खाना","पानी","आना","जाना","गाना","नाना","दादा","बाबा","काका","चाचा",
  "किला","मिला","खिल","जिल","गिल","चिड़","सिर","तिल","मिल","पिल",
  "सुना","बुना","धुना","गुना","मुना","जुना","कुना","चुना","रुना","पुना",
  "देश","मेज","बेल","खेत","रेत","जेब","वेद","केक","सेब","नेत",
  "पैसा","मैना","कैद","भैया","नैया","गैस","तैर","बैल","मैल","वैद",
  "मोर","गोल","बोल","डोल","खोल","टोल","रोल","जोल","पोल","नोल",
  "पौधा","मौसम","सौदा","कौआ","नौका","दौड़","लौट","तौल","मौत","गौर",
];

// Level 4 — simple sentences (pool of 40 sentences, 6 picked per test)
const RT_LV4_POOL = [
  "राम खाना खाता है।","सीता पानी पीती है।","मोहन स्कूल जाता है।",
  "गाय घास खाती है।","बच्चे खेलते हैं।","माँ खाना बनाती है।",
  "पक्षी आकाश में उड़ते हैं।","सूरज सुबह उगता है।",
  "हाथी बड़ा जानवर है।","बिल्ली दूध पीती है।",
  "कुत्ता भौंकता है।","मछली पानी में रहती है।",
  "फूल बहुत सुंदर हैं।","पेड़ हमें छाया देते हैं।",
  "नदी में पानी बहता है।","आसमान नीला है।",
  "बादल से बारिश होती है।","बच्चा रोता है।",
  "लड़की नाचती है।","लड़का दौड़ता है।",
  "किसान खेत जोतता है।","माली फूल लगाता है।",
  "मेज पर किताब है।","कुर्सी पर बच्चा बैठा है।",
  "घर में सब लोग हैं।","रात में चाँद निकलता है।",
  "दिन में सूरज चमकता है।","ठंडी हवा बहती है।",
  "बंदर पेड़ पर चढ़ता है।","शेर जंगल में रहता है।",
  "तोता हरा होता है।","कोयल मीठा गाती है।",
  "गुलाब का फूल लाल है।","कमल पानी में उगता है।",
  "मुर्गा सुबह बोलता है।","गाय हमें दूध देती है।",
  "हम सब भारतीय हैं।","हमारा देश भारत है।",
  "दिल्ली भारत की राजधानी है।","गंगा एक पवित्र नदी है।",
];

// Level 5 — short paragraphs (pool of 14, 1 picked per test)
const RT_LV5_POOL = [
  {title:"शेर और चूहा",text:"एक बार जंगल में एक शेर सो रहा था। एक छोटा चूहा उसके पास आया और उसके ऊपर कूद गया। शेर जाग गया और उसे पकड़ लिया। चूहे ने कहा, मुझे छोड़ दो, मैं एक दिन तुम्हारी मदद करूँगा। शेर हँसा और उसे जाने दिया। कुछ दिन बाद शेर एक जाल में फँस गया। चूहे ने जाल काट दिया और शेर को आज़ाद किया। दोनों अच्छे दोस्त बन गए।"},
  {title:"चींटी और टिड्डा",text:"गर्मियों में एक टिड्डा गाना गाता था। एक चींटी मेहनत करके अनाज जमा कर रही थी। टिड्डे ने पूछा, इतनी गर्मी में क्यों काम करती हो? चींटी ने कहा, जाड़े के लिए खाना जमा कर रही हूँ। सर्दी आई तो टिड्डे के पास कुछ नहीं था। चींटी के पास भरपूर खाना था। मेहनत का फल हमेशा मीठा होता है।"},
  {title:"प्यासा कौआ",text:"एक कौआ बहुत प्यासा था। उसने एक घड़ा देखा जिसमें थोड़ा पानी था। उसकी चोंच पानी तक नहीं पहुँच रही थी। कौए ने एक उपाय सोचा। उसने घड़े में कंकड़ डाले। पानी ऊपर आता गया। कौए ने पानी पिया और उड़ गया। चतुराई से हर काम हो सकता है।"},
  {title:"खरगोश और कछुआ",text:"एक खरगोश और कछुए में दौड़ की प्रतियोगिता हुई। खरगोश बहुत तेज़ था। दौड़ शुरू होते ही खरगोश आगे निकल गया। उसने सोचा, कछुआ बहुत धीमा है, थोड़ी देर आराम करता हूँ। वह सो गया। कछुआ धीरे-धीरे चलता रहा और दौड़ जीत गया। घमंड नहीं करना चाहिए।"},
  {title:"सच्चा दोस्त",text:"मोहन और सोहन दो दोस्त थे। एक दिन जंगल में जाते समय एक भालू आया। मोहन पेड़ पर चढ़ गया। सोहन को पेड़ चढ़ना नहीं आता था। उसने जमीन पर लेट कर साँस रोक ली। भालू ने उसे सूँघा और चला गया। मोहन ने पूछा, भालू ने क्या कहा? सोहन बोला, भालू ने कहा, मुसीबत में भागने वाले सच्चे दोस्त नहीं होते।"},
  {title:"बगुला और केकड़ा",text:"एक तालाब में बहुत मछलियाँ थीं। एक बूढ़ा बगुला मछलियाँ नहीं पकड़ पा रहा था। उसने एक चाल सोची। उसने मछलियों से कहा, पास में एक बड़ा तालाब है, मैं तुम्हें वहाँ ले जाऊँगा। मछलियाँ मान गईं। बगुला उन्हें एक-एक कर खाता रहा। एक दिन केकड़े को शक हुआ। उसने बगुले की गर्दन पकड़ ली। चालाकी हमेशा नहीं चलती।"},
  {title:"हमारा भारत",text:"भारत एक महान देश है। यहाँ अनेक धर्मों के लोग मिलकर रहते हैं। हिमालय उत्तर में है। दक्षिण में समुद्र है। गंगा, यमुना और ब्रह्मपुत्र यहाँ की प्रमुख नदियाँ हैं। भारत में अनेक भाषाएँ बोली जाती हैं। हिंदी राजभाषा है। हमें अपने देश पर गर्व है।"},
  {title:"मेरा स्कूल",text:"मेरा स्कूल बहुत सुंदर है। वहाँ बड़ा मैदान है। हम वहाँ खेलते हैं। स्कूल में बहुत अच्छे शिक्षक हैं। वे हमें पढ़ाते हैं। हम हिंदी, गणित और अंग्रेज़ी पढ़ते हैं। स्कूल में बगीचा भी है। उसमें रंगीन फूल खिलते हैं। मुझे अपना स्कूल बहुत पसंद है।"},
  {title:"वर्षा ऋतु",text:"वर्षा ऋतु में काले बादल आकाश में छा जाते हैं। बिजली चमकती है और बादल गरजते हैं। ठंडी हवा चलती है। फिर वर्षा होती है। मेंढक टर्राने लगते हैं। मोर नाचते हैं। नदी-नाले भर जाते हैं। धरती हरी-भरी हो जाती है। किसान खुश हो जाते हैं क्योंकि उनकी फसल अच्छी होती है।"},
  {title:"पेड़ हमारे मित्र",text:"पेड़ हमारे सच्चे मित्र हैं। वे हमें फल, फूल और लकड़ी देते हैं। पेड़ हमें छाया देते हैं। वे हवा को साफ़ करते हैं। पेड़ों की जड़ें मिट्टी को बाँधे रखती हैं। पेड़ों से हमें औषधियाँ भी मिलती हैं। हमें पेड़ काटने नहीं चाहिए। जितना हो सके, उतने पेड़ लगाने चाहिए।"},
  {title:"बुद्धिमान बंदर",text:"एक बार दो बिल्लियाँ एक रोटी के लिए लड़ रही थीं। एक बंदर वहाँ आया। उसने कहा, मैं तुम्हारे बीच रोटी बाँट देता हूँ। उसने रोटी को दो हिस्सों में तोड़ा। एक हिस्सा बड़ा था। उसने उसमें से थोड़ा खा लिया। अब दूसरा हिस्सा बड़ा हो गया। इस तरह बंदर ने पूरी रोटी खा ली। बिल्लियाँ पछताती रह गईं।"},
  {title:"मेहनती किसान",text:"एक किसान के तीन बेटे थे। वे आपस में बहुत लड़ते थे। किसान बीमार हो गया। उसने बेटों को बुलाया। लकड़ियों का एक गट्ठर लाया। उसने कहा, इसे तोड़ो। किसी से न टूटा। उसने एक-एक लकड़ी दी। सब आसानी से टूट गई। किसान ने कहा, मिलकर रहोगे तो कोई तुम्हें नहीं तोड़ पाएगा।"},
  {title:"चाँद और सितारे",text:"रात को आसमान में चाँद निकलता है। उसके साथ अनगिनत तारे चमकते हैं। चाँद की रोशनी में धरती जगमगा उठती है। बच्चे छत पर बैठकर चाँद-तारे देखते हैं। कवियों ने चाँद पर बहुत कविताएँ लिखी हैं। आज इंसान चाँद पर पहुँच चुका है। चाँद की यात्रा बहुत रोमांचक थी।"},
  {title:"स्वच्छ भारत",text:"गंदगी से बीमारियाँ होती हैं। हमें अपने घर, गली और मोहल्ले को साफ़ रखना चाहिए। कूड़े को कूड़ेदान में डालना चाहिए। नदियों को प्रदूषित नहीं करना चाहिए। पेड़-पौधे लगाने चाहिए। प्लास्टिक का उपयोग कम करना चाहिए। स्वच्छ भारत अभियान में हम सबको मिलकर भाग लेना चाहिए। स्वच्छता ही सेवा है।"},
];
...
const RT_GRADE = (wpm, target) => {
  ...
  if (pct >= 110) return { g:"A+", label:"Outstanding! 🏆", color:"#43A047" };
  if (pct >= 90)  return { g:"A",  label:"Excellent! 🎉",   color:"#43A047" };
  if (pct >= 75)  return { g:"B+", label:"Very Good! ⭐",   color:"#1E88E5" };
  if (pct >= 60)  return { g:"B",  label:"Good! 👍",        color:"#1E88E5" };
  if (pct >= 40)  return { g:"C",  label:"Keep Practising! 📚", color:"#FB8C00" };
  return           { g:"D",  label:"Need more practice 💪", color:"#E53935" };
};

const RT_LEVELS_META = [
  { id:"lv1", label:"बालवाटिका १", en:"Level 1 — Letter Grid",   color:"#FF7043", bg:"#FBE9E7", icon:"🌱", stars:1, wpmTarget:0,  lpmTarget:25, desc:"Read individual letters & syllables" },
  { id:"lv2", label:"बालवाटिका २", en:"Level 2 — Simple Words",  color:"#43A047", bg:"#E8F5E9", icon:"🌿", stars:2, wpmTarget:10, lpmTarget:0,  desc:"Read 2-letter words without matras" },
  { id:"lv3", label:"बालवाटिका ३", en:"Level 3 — Matra Words",   color:"#1E88E5", bg:"#E3F2FD", icon:"🌻", stars:3, wpmTarget:15, lpmTarget:0,  desc:"Read words with all matras" },
  { id:"c1",  label:"कक्षा १",     en:"Level 4 — Sentences",     color:"#8E24AA", bg:"#F3E5F5", icon:"⭐", stars:4, wpmTarget:25, lpmTarget:0,  desc:"Read simple Hindi sentences" },
  { id:"c2",  label:"कक्षा २",     en:"Level 5 — Paragraphs",    color:"#E53935", bg:"#FFEBEE", icon:"🏆", stars:5, wpmTarget:45, lpmTarget:0,  desc:"Read full paragraphs fluently" },
];
...
/* ─── Pick the best available Hindi voice ──────────────────────
   ...
   1. Google हिन्दी  — best natural voice, available on Chrome/Android
...
const _pickBestVoice = () => {
  ...
  return (
    find(v => v.lang === "hi-IN" && v.name.includes("Google हिन्दी")) ||
...
// Voices load async — grab them as soon as they're ready
...
const generateQ = (index) => {
  ...
  SWAR.forEach(s => {
    pool.push({
      type:"swar", q:`'${s.eg}' किस स्वर से शुरू होता है?`,
      img:s.em, answer:s.a,
  ...
  WORDS.forEach(w => {
    ...
    pool.push({
      type:"word", q:`'${w.em}' का हिंदी शब्द क्या है?`,
      img:w.em, answer:w.w,
  ...
  WORDS.forEach(w => {
    const others = WORDS.filter(x=>x.w!==w.w).slice(0,3);
    pool.push({
      type:"meaning", q:`'${w.w}' का अर्थ क्या है?`,
      img:w.em, answer:w.m,
  ...
  MATRAS.forEach(m => {
    pool.push({
      type:"matra", q:`'${m.eg}' में कौन सी मात्रा है?`,
  ...
  VYANJAN.forEach(v => {
    pool.push({
      type:"vyanjan", q:`'${v.eg}' किस व्यंजन से शुरू होता है?`,
      img:v.em, answer:v.a,
...
const seededQ = (seed) => {
  ...
  const all = [];
  SWAR.forEach(s => all.push({type:"swar",q:`'${s.eg}' किस स्वर से शुरू होता है?`,img:s.em,answer:s.a,choices:shuffle([s.a,...SWAR.filter(x=>x.a!==s.a).slice(0,3).map(x=>x.a)]),speak:s.eg}));
  WORDS.forEach(w => all.push({type:"word",q:`'${w.em}' का हिंदी शब्द?`,img:w.em,answer:w.w,choices:shuffle([w.w,...WORDS.filter(x=>x.w!==w.w).slice(0,3).map(x=>x.w)]),speak:w.w}));
  WORDS.forEach(w => all.push({type:"meaning",q:`'${w.w}' का अर्थ?`,img:w.em,answer:w.m,choices:shuffle([w.m,...WORDS.filter(x=>x.m!==w.m).slice(0,3).map(x=>x.m)]),speak:w.w}));
  MATRAS.forEach(m => all.push({type:"matra",q:`'${m.eg}' में कौन सी मात्रा?`,img:m.eg,answer:m.sym,choices:shuffle([m.sym,...MATRAS.filter(x=>x.sym!==m.sym).slice(0,3).map(x=>x.sym)]),speak:m.eg}));
  VYANJAN.forEach(v => all.push({type:"vyanjan",q:`'${v.eg}' किस व्यंजन से?`,img:v.em,answer:v.a,choices:shuffle([v.a,...VYANJAN.filter(x=>x.a!==v.a).slice(0,3).map(x=>x.a)]),speak:v.eg}));
...
const NAV_ITEMS = [
  ...
  {id:"endless",     icon:"♾️", label:"Endless"},
  {id:"practice",    icon:"🎮", label:"Quiz"},
  {id:"dashboard",   icon:"📊", label:"Me"},
];
...
const TopBar = ({ user, screen, setScreen }) => (
  <div style={{ background:"linear-gradient(135deg,#FF7043,#FF9800)", padding:"11px 16px",
    ...
    <div style={{ display:"flex", alignItems:"center", gap:9, cursor:"pointer" }}
      ...
      <div>
        <div className="hin" style={{ color:"#fff", fontWeight:900, fontSize:16, lineHeight:1 }}>हिंदी पाठशाला</div>
        <div style={{ color:"rgba(255,255,255,.8)", fontSize:9 }}>NEP 2020 · Hindi Literacy</div>
      </div>
    </div>
    <div style={{ display:"flex", gap:7, alignItems:"center" }}>
      {user && <div style={{ background:"rgba(255,255,255,.25)", color:"#fff", padding:"4px 11px",
        borderRadius:20, fontSize:11, fontWeight:700 }}>👤 {user.name}</div>}
...
/* ═══════════════════════════════════════════════════════
   EMAIL SERVICE  (EmailJS REST — no backend needed)
   ─────────────────────────────────────────────────────
   SETUP (free):
...
const sendEmail = async ({ to, toName, subject, otp = "", message }) => {
  if (!EMAIL_CONFIGURED) {
    // Demo mode — log to console and simulate success
    console.info(`📧 [DEMO] Email to ${to}\nSubject: ${subject}\nOTP: ${otp}\n${message}`);
...
const sendWelcomeEmail = (name, email, levelLabel) =>
  sendEmail({
    ...
    subject: "🎉 Welcome to हिंदी पाठशाला!",
    message: `नमस्ते ${name}! आपका हिंदी पाठशाला में स्वागत है।\n\nYour account has been created successfully!\nClass: ${levelLabel}\n\nStart learning Hindi today — Swar, Vyanjan, Stories, Voice Practice and more await you!\n\nशुभकामनाएँ,\nहिंदी पाठशाला Team`
  });

/* ═══════════════════════════════════════════════════════
   AI STORY GENERATOR  (Anthropic API — Claude)
...
const AI_DIFF_DESC = (d) => {
  if (d <= 2) return "very simple, 5-6 short sentences, only basic 2-3 letter words (नल, घर, फल), suitable for Balvatika 1 children aged 3-4";
  if (d <= 3) return "simple, 6-7 sentences, words without matras, Balvatika 2 level aged 4-5";
  if (d <= 4) return "easy, 7-8 sentences, words with simple matras (आ, इ, ई), Balvatika 3 level aged 5-6";
...
Difficulty level: ${difficulty}/10 — ${AI_DIFF_DESC(difficulty)}.${avoidStr}
...
- End with a simple moral lesson (नैतिक शिक्षा)
- Vocabulary must EXACTLY match the difficulty level
- Story must be fresh and original — never use Sher-Chuha or Pyasa Kauwa

Return ONLY a valid JSON object, no markdown, no explanation:
{"title":"हिंदी शीर्षक","text":"पूरी कहानी हिंदी में वाक्यों के साथ।","moral":"नैतिक शिक्षा एक वाक्य में।","difficulty":${difficulty},"emoji":"one relevant emoji character","wordCount":estimated_word_count}`;
  ...
  try {
    ...
    return {
      title: "परिश्रम का फल",
      text: `एक गाँव में राम नाम का लड़का रहता था। वह बहुत मेहनती था। हर रोज़ वह पढ़ाई करता था। उसके माता-पिता खेत में काम करते थे। राम उनकी मदद भी करता था। एक दिन उसके स्कूल में परीक्षा हुई। राम ने खूब पढ़कर परीक्षा दी। वह पूरे स्कूल में प्रथम आया। सभी ने उसे शाबाशी दी। मेहनत का फल मीठा होता है।`,
      moral: "मेहनत करने वाले को सफलता मिलती है।",
      difficulty, emoji: "📚", wordCount: 75, aiGenerated: false
    };
  }
};
...
/* ═══════════════════════════════════════════════════════
   AUTH SCREEN  (Login · SignUp · ForgotPassword)
═══════════════════════════════════════════════════════ */
const AuthScreen = ({ onAuthSuccess }) => {
  ...
  /* ── OTP state (shared for signup verify + forgot) ── */
  ...
  /* ══ STEP 1: VALIDATE SIGNUP FORM + SEND EMAIL OTP ══ */
  const doRequestSignupOtp = async () => {
    ...
    else if (ps.score < 2)          errs.password= "Password is too weak — add uppercase/numbers";
    ...
    const result = await sendEmail({
      ...
      subject: "✅ Verify your हिंदी पाठशाला account",
      otp: code,
      message: `नमस्ते ${fullName.trim()}!\n\nYour verification code for हिंदी पाठशाला is:\n\n🔐 ${code}\n\nThis code is valid for 10 minutes. Do not share it with anyone.\n\nIf you did not request this, please ignore this email.`
    });

    setLoading(false);

    if (result.demo) {
      showToast(`📧 Demo mode: OTP is ${code} (check browser console). Configure EmailJS to send real emails.`, "info");
    } else if (result.ok) {
      showToast(`✅ Verification code sent to ${email}!`, "success");
    } else {
      showToast("⚠️ Could not send email. Check EmailJS config. Demo OTP: " + code, "info");
    }
  ...
  /* ══ STEP 2: VERIFY OTP + CREATE ACCOUNT + SEND WELCOME ══ */
  const doCompleteSignup = async () => {
    ...
    sendWelcomeEmail(newUser.name, newUser.email, lv.label).then(r => {
      if (r.demo) console.info("📧 Welcome email (demo):", newUser.email);
    });

    setLoading(false);
    showToast(`🎉 Account verified! Welcome, ${newUser.name}!`);
  ...
  const doForgot = async () => {
    ...
    const result = await sendEmail({
      to: email.toLowerCase().trim(),
      toName: found.name,
      subject: "🔑 Reset your हिंदी पाठशाला password",
      otp: code,
      message: `नमस्ते ${found.name}!\n\nYour password reset code is:\n\n🔐 ${code}\n\nThis code expires in 10 minutes.\nIf you did not request this, ignore this email.`
    });

    setLoading(false);
    if (result.demo) {
      showToast(`📧 Demo mode: Reset OTP is ${code} (console). Configure EmailJS for real email.`, "info");
    } else if (result.ok) {
      showToast(`✅ Reset code sent to ${email}!`);
    } else {
      showToast("⚠️ Email failed. Demo OTP: " + code, "info");
    }
    setView("verifyOtp");
    clearErrors();
  };
  ...
  const LogoHeader = ({ subtitle }) => (
    <div style={{ textAlign:"center", marginBottom:28 }}>
      <div style={{ width:72, height:72, borderRadius:22, margin:"0 auto 12px",
        ...
        boxShadow:"0 8px 28px rgba(255,112,67,.4)" }}>📚</div>
      <div className="hin" style={{ fontSize:26, fontWeight:900, color:"#FF7043",
        textShadow:"0 2px 8px rgba(255,112,67,.2)" }}>हिंदी पाठशाला</div>
  ...
  if (view === "login") return (
    <div style={{ minHeight:"100vh", background:"linear-gradient(160deg,#FFF9F0,#FFF0E8)",
      ...
      <div style={cardStyle}>
        <div style={{ fontWeight:900, fontSize:22, color:"#222", marginBottom:6 }}>Welcome back! 👋</div>
        <div style={{ fontSize:13, color:"#888", marginBottom:22 }}>Sign in to continue your Hindi journey</div>

        <AuthInput label="Email Address" type="email" value={email} icon="📧"
          onChange={e=>{setEmail(e.target.value); setErrors({}); }}
          placeholder="you@example.com" error={errors.email} />

        <AuthInput label="Password" type={showPw?"text":"password"} value={password} icon="🔒"
      ...
      <div style={{ display:"flex", gap:8, marginTop:20, overflowX:"auto", scrollbarWidth:"none",
        ...
        {["🎵 Audio","🎤 Voice","♾️ Endless","🏆 Gamified","📖 5-Level Tests"].map(f => (
  ...
  if (view === "signup") return (
    <div style={{ minHeight:"100vh", background:"linear-gradient(160deg,#FFF9F0,#FFF0E8)",
      ...
      <div style={cardStyle}>
        <div style={{ fontWeight:900, fontSize:22, color:"#222", marginBottom:6 }}>Create Account 🌟</div>
        <div style={{ fontSize:13, color:"#888", marginBottom:22 }}>Join हिंदी पाठशाला for free!</div>

        <AuthInput label="Full Name / पूरा नाम" value={fullName} icon="👤"
        ...
        {/* Grade selector */}
        <div style={{ marginBottom:14 }}>
          <div style={{ fontSize:12, fontWeight:700, color:"#555", marginBottom:5 }}>Grade / कक्षा</div>
        ...
        <AuthInput label="Confirm Password" type={showCPw?"text":"password"} value={confirmPw} icon="🔑"
      ...
      <div style={cardStyle}>
        <div style={{ textAlign:"center", marginBottom:22 }}>
          ...
          {!EMAIL_CONFIGURED && (
            <div style={{ marginTop:10, background:"#FFF3E0", borderRadius:10,
              ...
              ⚙️ <strong>Demo mode</strong> — EmailJS not configured.<br/>
              OTP is shown in browser console (F12 → Console).
            </div>
          )}
        </div>
        ...
        <div style={{ background:"#F3E5F5", borderRadius:12, padding:"10px 14px",
          ...
          <div style={{ fontSize:12, color:"#555" }}>
            <div>👤 {fullName}</div>
            <div>📧 {email}</div>
            <div>🎓 {LEVELS.find(l=>l.id===grade)?.label} ({LEVELS.find(l=>l.id===grade)?.age})</div>
          </div>
        </div>
  ...
  if (view === "forgot") return (
    <div style={{ minHeight:"100vh", background:"linear-gradient(160deg,#FFF9F0,#FFF0E8)",
      ...
      <div style={cardStyle}>
        ...
        <AuthInput label="Registered Email" type="email" value={email} icon="📧"
          onChange={e=>{setEmail(e.target.value); setErrors({}); }}
          placeholder="you@example.com" error={errors.email} />
    ...
    <div style={{ minHeight:"100vh", background:"linear-gradient(160deg,#FFF9F0,#FFF0E8)",
      ...
      <div style={cardStyle}>
        ...
        {errors.otp && <div style={{ textAlign:"center", color:"#e53935",
          fontSize:12, marginBottom:12 }}>⚠️ {errors.otp}</div>}

        {/* New password */}
        <AuthInput label="New Password" type={showPw?"text":"password"} value={newPw} icon="🔒"
  ...
  return (
    <div className="fade-up" style={{ minHeight:"calc(100vh - 56px)",
      ...
      <div style={{ background:`linear-gradient(135deg,${lv.color},${lv.color}cc)`,
        ...
        <div style={{ color:"rgba(255,255,255,.85)", fontSize:13, marginBottom:4 }}>नमस्ते! 🙏</div>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:8, marginTop:6 }}>
          <div style={{ background:"rgba(255,255,255,.25)", borderRadius:10,
            ...
            <span className="hin">{lv.label}</span> · {lv.age}
          </div>
          <div style={{ background:"rgba(255,255,255,.25)", borderRadius:10,
            padding:"4px 12px", fontSize:12, color:"#fff", fontWeight:700 }}>
            ⭐ {user.points} pts
        ...
        <div style={{ display:"flex", gap:10, marginTop:20 }}>
          {[["🔥", user.streak||1, "Streak"],["📖",user.wpm||0,"WPM"],["♾️",user.endlessCount||0,"Practice"]].map(([ic,v,l]) => (
      ...
      <div style={{ padding:"18px 20px 0" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginBottom:16 }}>
          {[
            {id:"learn",       icon:"✏️", label:"Learn Letters",  sub:"Swar · Vyanjan · Matras", color:"#FF7043", bg:"#FBE9E7"},
            {id:"reading",     icon:"📖", label:"Reading Test",   sub:"5 levels · WPM grade",   color:"#1E88E5", bg:"#E3F2FD"},
            {id:"endless",     icon:"♾️", label:"Endless Quiz",   sub:"Never-ending practice",  color:"#8E24AA", bg:"#F3E5F5"},
            {id:"practice",    icon:"🎮", label:"Quiz",           sub:"3 quiz categories",       color:"#43A047", bg:"#E8F5E9"},
          ].map(item => (
        ...
        <div style={{ background:"linear-gradient(135deg,#1A237E,#283593)",
          ...
          <div style={{ color:"rgba(255,255,255,.8)", fontSize:11, marginBottom:8 }}>
            🌟 Everything in हिंदी पाठशाला
          </div>
          <div style={{ display:"flex", flexWrap:"wrap", gap:8 }}>
            {["🎵 Audio TTS","🎤 Voice Record","📖 5-Level Reading","♾️ Endless Practice",
              "🏆 Leaderboard","📊 WPM Tracker","📜 Certificates","🧑‍🏫 Teacher Panel"].map(f => (
        ...
        <div onClick={() => setScreen("dashboard")}
          ...
          <div style={{ flex:1 }}>
            ...
            <div style={{ fontSize:11, color:"#888", marginTop:2 }}>
              Level progress · Badges · Weekly chart
            </div>
          </div>
          <div style={{ color:"#FF7043", fontSize:20 }}>›</div>
        </div>
      </div>
    </div>
  );
...
const useMicPermission = () => {
  ...
  const checkPermission = useCallback(async () => {
    ...
    try {
      ...
      // Firefox doesn't support permissions.query for mic — assume prompt
...
const useVoiceCapture = () => {
  ...
  const startRecording = useCallback(async (stream) => {
    ...
    // ── SpeechRecognition for transcript matching ──
    ...
    if (SR) {
      ...
      rec.onerror = () => {}; // silent — audio playback still works
      try { rec.start(); } catch {}
    }
...
/* ═══════════════════════════════════════════════════════
   ...
   Shows before any voice feature — asks user to allow mic
═══════════════════════════════════════════════════════ */
    ...
    <div className="fade-up" style={{ background:"#fff", borderRadius:20,
      ...
      <div style={{ fontSize:13, color:"#666", lineHeight:1.6, marginBottom:20 }}>
        ...
        <span style={{ background:"#FFF3E0", borderRadius:8, padding:"4px 10px",
          ...
          ℹ️ Your audio stays on your device — nothing is uploaded
        </span>
      </div>
      ...
      <div style={{ background:"#E3F2FD", borderRadius:12, padding:"10px 14px",
        ...
        <strong>📌 When Chrome asks:</strong><br/>
        Tap <strong>"Allow"</strong> in the popup that appears at the top of your browser.
        If you accidentally blocked it, click the 🔒 lock icon in the address bar → Microphone → Allow.
      </div>
...
const VoicePractice = ({ user, setUser }) => {
  ...
  const checkMatch = (said) => {
    if (!said) return; // no transcript — user can still listen to playback, just no match score
      ...
      {!showPermGate && (
        <>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:12,
            ...
            <div style={{ fontSize:16 }}>{micReady?"✅":"⚠️"}</div>
            <div style={{ fontSize:11, color:micReady?"#2e7d32":"#E65100", fontWeight:700 }}>
              {micReady
                ? "Microphone: Ready"
                : "Microphone permission needed — tap the mic button below"}
            </div>
          </div>
          ...
          <div style={{ textAlign:"center", color:"#888", fontSize:12, marginBottom:16,
            fontWeight:600 }}>
            {!micReady       ? "👇 Tap the mic button to allow microphone access" :
             recState==="idle"    ? "👇 Tap & hold the mic, say the word aloud in Hindi" :
             isRecording          ? `🔴 Recording... ${duration}s — tap STOP when done` :
             isDone               ? "✅ Recorded! Listen below or try again" :
             "❌ Error. Try again."}
          </div>

          {/* ── Record / Stop buttons ── */}
          <div style={{ display:"flex", justifyContent:"center", gap:16, marginBottom:16 }}>
            {/* MIC button — shows when idle or needs permission */}
            {!isRecording && (
            ...
            {/* STOP button — pulsing red while recording */}
            {isRecording && (
                ...
                {transcript ? (
                  <>
                    ...
                    <div style={{ fontSize:20, marginTop:8 }}>
                      {result==="correct"?"🎉 शाबाश! Perfect match!":
                       result==="close"  ?"🔶 Almost there!":
                       result===null     ?"🎧 Listen to your recording above":
                  ...
                  <>
                    ...
                    <div style={{ fontSize:11, color:"#888", marginTop:4 }}>
                      (Speech-to-text didn't catch it — try Chrome or speak clearly)
                    </div>
                  </>
                )}
              </div>
          ...
          {user && (
            <div style={{ marginTop:14, textAlign:"center", fontSize:12, color:"#888" }}>
              🎤 Voice matches: {user.voiceMatches||0} / 10 for 🎤 Voice Star badge
            </div>
          )}
        </>
      )}
...
const LearnScreen = ({ user, setUser }) => {
  ...
  const TABS = [
    {id:"swar",    label:"स्वर",     icon:"🔤"},
    {id:"vyanjan", label:"व्यंजन",   icon:"📝"},
    {id:"matras",  label:"मात्राएँ", icon:"🔠"},
    {id:"words",   label:"शब्द",     icon:"📖"},
    {id:"sentences",label:"वाक्य",   icon:"✍️"},
    {id:"story",   label:"कहानी",    icon:"📕"},
    {id:"speed",   label:"Speed",    icon:"⏱️"},
    {id:"voice",   label:"🎤 Record", icon:"🎤"},
  ];
  ...
  return (
    <div className="fade-up" style={{ minHeight:"calc(100vh-56px)", background:"#FFF9F0", paddingBottom:90, paddingTop:8 }}>
      <div style={{ padding:"0 20px 10px" }}>
        <H>✏️ Learn Hindi / हिंदी सीखें</H>
        <div style={{ fontSize:11, color:"#888", marginBottom:10 }}>🔊 Tap any card to hear pronunciation!</div>
      </div>
            ...
            {MATRAS.map(m => (
              <div key={m.sym} onClick={() => tap(m.eg)}
                ...
                <div style={{ background:m.color, color:"#fff", borderRadius:10,
                  padding:"5px 12px", fontSize:13, fontWeight:700 }}>🔊</div>
              </div>
            ))}
          </div>
        )}
          ...
          <div className="fade-up">
            <Card style={{ background:"linear-gradient(135deg,#FFF3E0,#FBE9E7)", marginBottom:14 }}>
              <div style={{ fontWeight:800, fontSize:15, color:"#FF7043", marginBottom:10 }}>
                📕 शेर और चूहा — The Lion & the Mouse
              </div>
              <div style={{ display:"flex", gap:8, marginBottom:12 }}>
                <Btn onClick={()=>speak(STORY,0.7)} color="#FF7043" style={{ flex:1, padding:10, fontSize:12 }}>🔊 Read Full Story</Btn>
                <Btn onClick={()=>window.speechSynthesis.cancel()} color="#888" style={{ flex:1, padding:10, fontSize:12 }}>⏹ Stop</Btn>
              </div>
              {STORY.split("\n").map((line, i) => (
        ...
        {tab==="speed" && (
          <div className="fade-up">
            <div style={{ fontSize:11, color:"#888", marginBottom:12 }}>
              Press Start → read aloud → tap each word as you say it → Stop to see your WPM
            </div>
            <div style={{ display:"flex", gap:8, marginBottom:14 }}>
              {[["⏱️",timeStr,"Time","#FF7043"],["📖",wpmWords,"Words","#43A047"],["⚡",wpm,"WPM","#1E88E5"]].map(([icon,val,label,color]) => (
            ...
            <Card style={{ marginBottom:12, border:timerOn?"2px solid #FF7043":"2px solid #f0f0f0", padding:"12px 14px" }}>
              <div style={{ fontSize:10, color:timerOn?"#FF7043":"#bbb", fontWeight:700, marginBottom:8 }}>
                {timerOn?"🔴 Recording — tap words as you read!":"Press START, then tap each word as you read it aloud"}
              </div>
            ...
            <div style={{ display:"flex", gap:10 }}>
              <Btn onClick={startTimer} disabled={timerOn} color="#43A047" style={{ flex:1, fontSize:14 }}>▶ Start</Btn>
              <Btn onClick={stopTimer}  disabled={!timerOn} color="#E53935" style={{ flex:1, fontSize:14 }}>⏹ Stop</Btn>
            </div>
            {!timerOn && wpm > 0 && (
              <div className="pop-in" style={{ marginTop:14, background:"linear-gradient(135deg,#FF7043,#FF9800)",
                ...
                <div style={{ fontSize:11, marginTop:6, opacity:.85 }}>
                  {wpm<15?"🌱 Keep practicing!":wpm<30?"⭐ Good progress!":wpm<45?"🚀 Excellent!":"🏆 Grade 2 target achieved!"}
                </div>
              </div>
            )}
          </div>
        ...
        {tab==="voice" && (
          <div className="fade-up">
            <div style={{ background:"linear-gradient(135deg,#FBE9E7,#FFF3E0)", borderRadius:16,
              ...
              <div style={{ fontWeight:800, fontSize:14, color:"#FF7043", marginBottom:4 }}>🎤 Listen & Repeat</div>
              <div style={{ fontSize:11, color:"#666" }}>
                1. Tap 🔊 to hear the word  2. Tap the mic and say it  3. See if you matched!
              </div>
            </div>
...
const QuizScreen = ({ user, setUser }) => {
  ...
  const buildSwarQs = () => SWAR.slice(0,5).map(s => ({
    q:`'${s.eg}' किस स्वर से शुरू होता है?`, img:s.em, answer:s.a,
    choices:shuffle([s.a,...SWAR.filter(x=>x.a!==s.a).slice(0,3).map(x=>x.a)]),
    speak:s.eg,
  }));
  const buildWordQs = () => WORDS.slice(0,5).map(w => ({
    q:`'${w.em}' का हिंदी शब्द क्या है?`, img:w.em, answer:w.w,
    choices:shuffle([w.w,...WORDS.filter(x=>x.w!==w.w).slice(0,3).map(x=>x.w)]),
    speak:w.w,
  }));
  const buildMatraQs = () => MATRAS.slice(0,5).map(m => ({
    q:`'${m.eg}' में कौन सी मात्रा है?`, img:m.eg, answer:m.sym,
    choices:shuffle([m.sym,...MATRAS.filter(x=>x.sym!==m.sym).slice(0,3).map(x=>x.sym)]),
    speak:m.eg,
  }));

  const QUIZZES = {
    swar:  {title:"🔤 स्वर Quiz",   color:"#FF7043", bg:"#FBE9E7", build:buildSwarQs},
    words: {title:"📖 शब्द Quiz",   color:"#43A047", bg:"#E8F5E9", build:buildWordQs},
    matra: {title:"🔠 मात्रा Quiz", color:"#8E24AA", bg:"#F3E5F5", build:buildMatraQs},
  };
  ...
  if (mode==="menu") return (
    <div className="fade-up" style={{ minHeight:"calc(100vh-56px)",
      ...
      <div style={{ padding:"0 20px" }}>
        <H>🎮 Quiz / परीक्षा</H>
        <div style={{ fontSize:11, color:"#888", marginBottom:18 }}>5 questions · 25 points each · 125 pts max</div>
          ...
          <div key={id} onClick={() => startQuiz(id)}
            ...
            <div style={{ display:"flex", justifyContent:"flex-end", marginTop:12 }}>
              <div style={{ background:q.color, color:"#fff", borderRadius:10,
                padding:"6px 18px", fontWeight:800, fontSize:13 }}>Start →</div>
            </div>
          </div>
        ))}
        <div style={{ marginTop:8, textAlign:"center" }}>
          <div style={{ fontSize:12, color:"#888" }}>Want unlimited questions?</div>
          <div style={{ fontSize:12, color:"#FF7043", fontWeight:700 }}>Tap ♾️ Endless in the nav below!</div>
        </div>
      </div>
    </div>
  );
      ...
      <div className="fade-up" style={{ minHeight:"calc(100vh-56px)",
        ...
        <div style={{ padding:"0 20px", textAlign:"center" }}>
          ...
          <div style={{ fontWeight:800, fontSize:24, color:"#333", marginTop:16 }}>
            {pct>=80?"शाबाश! Excellent!":pct>=60?"अच्छा! Good job!":"Keep practicing!"}
          </div>
          ...
          <Btn onClick={() => setMode("menu")} style={{ width:"100%", padding:15 }}>🎮 Try Another Quiz</Btn>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="fade-up" style={{ minHeight:"calc(100vh-56px)",
      ...
      <div style={{ padding:"0 20px" }}>
        ...
        <div style={{ fontSize:11, color:"#888", marginTop:4, marginBottom:16 }}>Score: {score} · +{score*25} pts</div>
        ...
        <Card style={{ textAlign:"center", marginBottom:18, padding:"22px 20px" }}>
          ...
          <button onClick={() => speak(q.speak)}
            style={{ marginTop:10, background:"none", border:"2px solid #FFD0B0",
              ...
              color:"#FF7043", fontWeight:700 }}>🔊 सुनो</button>
        </Card>
            ...
            return (
              <div key={i} onClick={() => choose(i)}
                ...
                <div className="hin" style={{ fontSize:21, fontWeight:900, color:textColor }}>
                  {chosen!==null&&i===ansIdx?"✅ ":chosen===i&&!correct?"❌ ":""}{choice}
                </div>
              </div>
            );
          })}
          ...
          <div className="pop-in">
            <div style={{ background:correct?"#E8F5E9":"#FFEBEE", borderRadius:14,
              ...
              <div className="hin" style={{ fontWeight:800, fontSize:15,
                ...
                {correct?"शाबाश! Correct!":` सही उत्तर: ${q.answer}`}
              </div>
            </div>
...
const EndlessScreen = ({ user, setUser }) => {
  ...
  const getQ = useCallback((num) => {
    ...
    if (filter==="all"||filter==="swar")
      SWAR.forEach(s => pool.push({type:"स्वर",q:`'${s.eg}' किस स्वर से शुरू होता है?`,img:s.em,answer:s.a,choices:shuffle([s.a,...SWAR.filter(x=>x.a!==s.a).slice(0,3).map(x=>x.a)]),speak:s.eg,color:"#FF7043"}));
    if (filter==="all"||filter==="word")
      WORDS.forEach(w => pool.push({type:"शब्द",q:`'${w.em}' का हिंदी शब्द?`,img:w.em,answer:w.w,choices:shuffle([w.w,...WORDS.filter(x=>x.w!==w.w).slice(0,3).map(x=>x.w)]),speak:w.w,color:"#43A047"}));
    if (filter==="all"||filter==="meaning")
      WORDS.forEach(w => pool.push({type:"अर्थ",q:`'${w.w}' का अर्थ?`,img:w.em,answer:w.m,choices:shuffle([w.m,...WORDS.filter(x=>x.m!==w.m).slice(0,3).map(x=>x.m)]),speak:w.w,color:"#1E88E5"}));
    if (filter==="all"||filter==="matra")
      MATRAS.forEach(m => pool.push({type:"मात्रा",q:`'${m.eg}' में कौन सी मात्रा?`,img:m.eg,answer:m.sym,choices:shuffle([m.sym,...MATRAS.filter(x=>x.sym!==m.sym).slice(0,3).map(x=>x.sym)]),speak:m.eg,color:"#8E24AA"}));
    if (filter==="all"||filter==="vyanjan")
      VYANJAN.forEach(v => pool.push({type:"व्यंजन",q:`'${v.eg}' किस व्यंजन से?`,img:v.em,answer:v.a,choices:shuffle([v.a,...VYANJAN.filter(x=>x.a!==v.a).slice(0,3).map(x=>x.a)]),speak:v.eg,color:"#E53935"}));
    if (!pool.length) pool = [...WORDS.map(w => ({type:"शब्द",q:`'${w.em}' का हिंदी शब्द?`,img:w.em,answer:w.w,choices:shuffle([w.w,...WORDS.filter(x=>x.w!==w.w).slice(0,3).map(x=>x.w)]),speak:w.w,color:"#43A047"}))];
  ...
  const FILTERS = [
    {id:"all",    label:"सब",     color:"#FF7043"},
    {id:"swar",   label:"स्वर",   color:"#FF7043"},
    {id:"word",   label:"शब्द",   color:"#43A047"},
    {id:"meaning",label:"अर्थ",   color:"#1E88E5"},
    {id:"matra",  label:"मात्रा", color:"#8E24AA"},
    {id:"vyanjan",label:"व्यंजन", color:"#E53935"},
  ];
    ...
    <div className="fade-up" style={{ minHeight:"calc(100vh-56px)",
      ...
      <div style={{ padding:"0 20px 0" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:12 }}>
          <div>
            <div style={{ fontWeight:800, fontSize:18, color:"#333" }}>♾️ Endless Practice</div>
            <div style={{ fontSize:11, color:"#888" }}>Question #{qNum+1} · Never ends!</div>
          </div>
          <div style={{ textAlign:"right" }}>
            <div style={{ fontWeight:900, fontSize:20, color:"#FF7043" }}>{score} ✓</div>
            <div style={{ fontSize:11, color:"#888" }}>🔥 Streak: {streak}</div>
          </div>
        </div>
        ...
        {streak >= 3 && (
          <div className="pop-in" style={{ background:"linear-gradient(90deg,#FF7043,#FF9800)",
            ...
            <div style={{ fontSize:24 }}>{streak>=10?"🔥🔥🔥":streak>=5?"🔥🔥":"🔥"}</div>
            <div>
              <div style={{ color:"#fff", fontWeight:800, fontSize:13 }}>{streak} in a row! 🎉</div>
        ...
        <Card style={{ textAlign:"center", marginBottom:16, padding:"22px 20px",
          ...
          <button onClick={() => speak(q.speak)}
            style={{ marginTop:10, background:"none", border:`2px solid ${q.color}60`,
              borderRadius:10, padding:"5px 14px", cursor:"pointer", fontSize:12,
              color:q.color, fontWeight:700 }}>🔊 सुनो</button>
        </Card>
        ...
        {chosen!==null && (
          <div className="pop-in">
            <div style={{ background:correct?"#E8F5E9":"#FFEBEE", borderRadius:14,
              padding:"11px 16px", textAlign:"center", marginBottom:12,
              border:`2px solid ${correct?"#43A047":"#e53935"}` }}>
              <div style={{ fontSize:20 }}>{correct?"🎉":"😅"}</div>
              <div className="hin" style={{ fontWeight:800, fontSize:15,
                color:correct?"#2e7d32":"#c62828" }}>
                {correct?`शाबाश! +${streak>=5?30:streak>=3?20:10} pts!`:`सही: ${q.answer}`}
              </div>
              {correct&&streak>=3&&<div style={{ fontSize:11, color:"#2e7d32" }}>🔥 Streak bonus!</div>}
            </div>
        ...
        <div style={{ marginTop:16 }}>
          <div onClick={() => setShowStats(s=>!s)}
            ...
            {showStats?"▲ Hide Stats":"▼ Show Session Stats"}
          </div>
          {showStats && (
            <div className="fade-up" style={{ marginTop:10, display:"grid",
              gridTemplateColumns:"1fr 1fr 1fr", gap:10 }}>
              {[["✅",score,"Correct"],["🔥",bestStreak,"Best Streak"],["📋",qNum+1,"Attempted"]].map(([icon,val,label]) => (
...
const LeaderboardScreen = ({ user }) => {
  const myEntry = user ? [{ name:user.name, av:"🧑", pts:user.points, wpm:user.wpm||0,
  ...
  return (
    <div className="fade-up" style={{ minHeight:"calc(100vh-56px)", background:"#FFF9F0", paddingBottom:90 }}>
      <div style={{ background:"linear-gradient(135deg,#1A237E,#283593)", padding:"20px 20px 42px" }}>
        <div style={{ fontWeight:800, fontSize:22, color:"#fff" }}>🏆 Leaderboard</div>
        ...
        {top3.map((s, i) => s && (
          <div key={s.name+i} style={{ flex:1, textAlign:"center" }}>
            ...
            <div style={{ background:["#C0C0C0","#FFD700","#CD7F32"][i],
              ...
              <div style={{ fontSize:22 }}>{[2,1,3][i]===1?"🥇":[2,1,3][i]===2?"🥈":"🥉"}</div>
            ...
            <div key={s.name+i} style={{ background:isMe?"#FBE9E7":"#fff",
              ...
              <div style={{ flex:1 }}>
                <div style={{ fontWeight:700, fontSize:13, color:"#333" }}>
                  {s.name} {isMe&&<span style={{ color:"#FF7043" }}>← You</span>}
                </div>
                <div style={{ fontSize:10, color:"#888" }}>
                  {s.lvl} · {s.wpm} WPM · 🔥{s.streak}
                </div>
              </div>
              <div style={{ textAlign:"right" }}>
...
const DashboardScreen = ({ user, setUser, setScreen, onLogout }) => {
  if (!user) return (
    <div style={{ minHeight:"calc(100vh-56px)", display:"flex", flexDirection:"column",
      ...
      <Btn onClick={() => setScreen("home")} style={{ padding:"14px 40px" }}>🏠 Go to Home & Login</Btn>
    </div>
  );
  ...
  return (
    <div className="fade-up" style={{ minHeight:"calc(100vh-56px)", background:"#FFF9F0", paddingBottom:90 }}>
      ...
      <div style={{ background:"linear-gradient(135deg,#FF7043,#FF9800)", padding:"20px 20px 28px" }}>
        <div style={{ color:"rgba(255,255,255,.8)", fontSize:12 }}>नमस्ते!</div>
        <div style={{ color:"#fff", fontWeight:900, fontSize:24, marginTop:2 }}>{user.name} 👋</div>
        <div style={{ color:"rgba(255,255,255,.85)", fontSize:12, marginTop:2 }}>
          🔥 {user.streak} day streak · <span className="hin">{lv.label}</span>
        </div>
        <div style={{ display:"flex", gap:9, marginTop:14 }}>
          {[["⭐",user.points,"Points"],["📖",user.wpm||0,"Best WPM"],["🏅",earnedCount,"Badges"],["♾️",user.endlessCount||0,"Endless"]].map(([icon,val,label]) => (
        ...
        {LEVELS.map(lv2 => (
          <div key={lv2.id} style={{ background:"#fff", borderRadius:14, padding:"11px 14px",
            ...
            <div style={{ fontSize:9, color:"#bbb", marginTop:3 }}>
              {prog[lv2.id]===100?"✅ Complete!":prog[lv2.id]===0?"🔒 Locked":"In progress..."}
            </div>
          </div>
        ))}
          ...
          <div style={{ display:"flex", gap:10, overflowX:"auto", paddingBottom:8, scrollbarWidth:"none" }}>
            {BADGES.map((b, i) => (
              <div key={b.name} style={{ flexShrink:0, background:i<earnedCount?"#fff":"#f5f5f5",
                ...
                <div style={{ fontSize:24 }}>{i<earnedCount?b.icon:"🔒"}</div>
    ...
    <div style={{ minHeight:"100vh", background:"#f4f6f9", paddingBottom:40 }}>
      <div style={{ background:"linear-gradient(135deg,#1A237E,#283593)", padding:"16px 20px 24px" }}>
        <div onClick={() => setScreen("home")} style={{ color:"rgba(255,255,255,.6)",
          fontSize:12, cursor:"pointer", marginBottom:8 }}>← Back to app</div>
        <div style={{ color:"#fff", fontWeight:900, fontSize:22 }}>🧑‍🏫 Teacher Dashboard</div>
        <div style={{ color:"rgba(255,255,255,.7)", fontSize:11, marginTop:2 }}>Monitor · Manage · Motivate</div>
      </div>

      <div style={{ display:"flex", gap:7, padding:"12px 20px",
        overflowX:"auto", scrollbarWidth:"none", background:"#fff",
        boxShadow:"0 2px 8px rgba(0,0,0,.06)" }}>
        {[["overview","📊","Overview"],["students","👥","Students"],["reports","📋","Reports"],["tech","💻","Tech Guide"]].map(([id,icon,label]) => (
        ...
        {tab==="overview" && (
          <div>
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10, marginBottom:14 }}>
              {[["👥","24","Total Students"],["📈","73%","Avg. Progress"],["⏱️","28","Avg. WPM"],["🏅","142","Badges Given"]].map(([icon,val,label]) => (
                <Card key={label}>
            ...
            <Card style={{ marginBottom:12 }}>
              <div style={{ fontWeight:700, fontSize:14, color:"#333", marginBottom:12 }}>📊 Class Distribution</div>
              {LEVELS.map((lv, i) => (
            ...
            <Card style={{ background:"#FFF3E0", border:"2px dashed #FF9800" }}>
              <div style={{ fontWeight:700, fontSize:13, color:"#FF7043", marginBottom:8 }}>⚠️ Needs Attention</div>
              {[["Dev Kumar","BV3","No activity in 3 days"],["Rohan","Class 1","WPM below target"]].map(([n,c,note]) => (
                <div key={n} style={{ display:"flex", gap:10, marginBottom:8, alignItems:"flex-start" }}>
                  <span style={{ fontSize:22 }}>👦</span>
                  <div>
                    <div style={{ fontWeight:700, fontSize:12, color:"#333" }}>{n} · {c}</div>
        ...
        {tab==="reports" && (
          <div>
            <Card style={{ marginBottom:14 }}>
              <div style={{ fontWeight:800, fontSize:14, color:"#333", marginBottom:12 }}>📋 Auto Report Card — Sample</div>
              <div style={{ border:"2px solid #e8eaf6", borderRadius:14, overflow:"hidden" }}>
                <div style={{ background:"linear-gradient(135deg,#1A237E,#283593)",
                  padding:"11px 16px", color:"#fff" }}>
                  <div style={{ fontWeight:800, fontSize:14 }}>Hindi Pathshala · Progress Report</div>
                  <div style={{ fontSize:10, opacity:.75 }}>Term 1 · 2025–26</div>
                </div>
          ...
          <div>
            <Card style={{ background:"#E3F2FD", border:"2px solid #1E88E530", marginBottom:12 }}>
              <div style={{ fontWeight:700, fontSize:13, color:"#1565C0", marginBottom:3 }}>
                💡 For Teachers with Limited Coding Knowledge
              </div>
              <div style={{ fontSize:11, color:"#444" }}>
                Hire a freelancer on <strong>Freelancer.in</strong> or <strong>Fiverr.com</strong>.
                Budget: <strong>₹15,000–₹40,000 · 6–8 weeks</strong>
              </div>
            </Card>
            {TECH.map(t => (
              <Card key={t.tool} style={{ marginBottom:8, padding:"11px 14px",
                ...
                <div style={{ flex:1 }}>
                  ...
                  <div style={{ fontSize:11, color:"#888" }}>{t.use} · {t.why}</div>
                </div>
            ...
            <div style={{ marginTop:14 }}>
              <H>🗺️ Build Roadmap</H>
              {[["Phase 1 (Wk 1–2)","Student auth, letter cards, audio TTS"],
                ["Phase 2 (Wk 3–4)","Points, badges, leaderboard, level unlock"],
                ["Phase 3 (Wk 5–6)","Speed test, WPM tracker, voice recording, teacher panel"],
                ["Phase 4 (Wk 7–8)","Endless practice engine, report cards, certificates, offline mode"]].map(([ph,d], i) => (
...
/* ═══════════════════════════════════════════════════════
   SCREEN: READING TEST — 5 Levels, Non-repeating content
═══════════════════════════════════════════════════════ */
const ReadingTestScreen = ({ user, setUser }) => {
  ...
  const [passEmoji,  setPassEmoji]  = useState("📖");
  ...
  // Mic permission — managed as a distinct step before test starts
  ...
  /* ═══════════════════════════════════════════════════════════
     handleAllowMic — called DIRECTLY from button onClick
  ...
  /* ═══════════════════════════════════════════════════════════
     _beginRecording — stream is already live when this is called
  ═══════════════════════════════════════════════════════════ */
  ...
  const buildPassage = async (lvId) => {
    setAiError(null); setPassMoral(""); setPassEmoji("📖");
    ...
    if (lvId === "lv1") {
      ...
      setPassTitle("अक्षर पढ़ो — Read each letter / syllable");
    } else if (lvId === "lv2") {
      ...
      setPassTitle("शब्द पढ़ो — Read each word");
    } else if (lvId === "lv3") {
      ...
      setPassTitle("मात्रा शब्द पढ़ो — Read words with matras");
    } else if (lvId === "c1") {
      ...
      setPassTitle("वाक्य पढ़ो — Read sentences aloud");
    } else if (lvId === "c2") {
      setAiLoading(true);
      ...
      try {
        ...
        setPassMoral(story.moral||""); setPassEmoji(story.emoji||"📖");
  ...
  const startTest = () => {
    ...
    _beginRecording(); // stream already live — starts immediately, no delay needed
  };
  ...
  const stopTest = () => {
    clearInterval(testTimerRef.current);
    _killRecorder(); // onstop fires → audioURL gets set
    ...
    <div className="fade-up" style={{minHeight:"calc(100vh - 56px)",background:"#FFF9F0",paddingBottom:90,paddingTop:8}}>
      <div style={{padding:"0 20px 16px"}}>
        <div style={{background:"linear-gradient(135deg,#1A237E,#311B92)",borderRadius:20,padding:"20px",marginBottom:18,color:"#fff"}}>
          ...
          <div style={{fontSize:12,opacity:.8,marginTop:3}}>5 levels · AI stories · 🎤 Record &amp; listen back</div>
        </div>
              ...
              <div style={{flex:1}}>
                <div style={{display:"flex",alignItems:"center",gap:6}}>
                  ...
                  {lv.id==="c2"&&<span style={{background:"linear-gradient(90deg,#FF7043,#8E24AA)",
                    color:"#fff",fontSize:8,fontWeight:800,padding:"2px 7px",borderRadius:8}}>✨ AI</span>}
                </div>
        ...
        <div style={{background:"#F3E5F5",borderRadius:14,padding:"12px 16px",border:"1px solid #CE93D8"}}>
          <div style={{fontWeight:700,fontSize:12,color:"#7B1FA2",marginBottom:5}}>💡 How it works</div>
          <div style={{fontSize:11,color:"#555",lineHeight:1.9}}>
            1. Pick a level<br/>
            2. Tap <strong>"Allow Microphone"</strong> — Chrome will ask permission<br/>
            3. Read aloud &amp; tap each word<br/>
            4. Tap STOP → see WPM score + grade<br/>
            5. 🎧 <strong>Listen back to your own voice!</strong>
          </div>
        </div>
      </div>
    </div>
  ...
  /* ════════════════════════════════════════════════════
     READY — dedicated mic permission step
  ════════════════════════════════════════════════════ */
    ...
    <div className="fade-up" style={{minHeight:"calc(100vh - 56px)",background:"#FFF9F0",paddingBottom:90,paddingTop:8}}>
      <div style={{padding:"0 20px"}}>
        ...
        <div style={{background:meta.bg,border:`2px solid ${meta.color}30`,borderRadius:18,padding:"18px",marginBottom:16,textAlign:"center"}}>
          <div style={{fontSize:44}}>{aiLoading?"⏳":passEmoji}</div>
          <div className="hin" style={{fontWeight:900,fontSize:22,color:meta.color,marginTop:8}}>
            {aiLoading?"AI Story बन रही है...":passTitle}
          </div>
          {selLevel==="c2"&&!aiLoading&&(
            <div style={{marginTop:8,display:"flex",justifyContent:"center"}}>
              <div style={{background:"linear-gradient(90deg,#FF7043,#8E24AA)",color:"#fff",borderRadius:12,padding:"4px 14px",fontSize:11,fontWeight:800}}>
                ✨ AI Story · Difficulty {storyHist.difficulty}/10
              </div>
            </div>
          )}
          {passMoral&&!aiLoading&&<div style={{marginTop:8,background:"rgba(255,255,255,.6)",borderRadius:10,padding:"6px 12px",fontSize:11,color:"#555"}}><span className="hin">💡 {passMoral}</span></div>}
        </div>

        {aiLoading&&<div style={{textAlign:"center",padding:"14px 0"}}><div className="spin" style={{display:"inline-block",fontSize:36}}>⚙️</div><div style={{color:"#8E24AA",fontWeight:700,marginTop:10}}>Claude AI नई Hindi कहानी लिख रहा है...</div></div>}
        {aiError&&<div style={{background:"#FFEBEE",borderRadius:12,padding:"14px",marginBottom:14,border:"2px solid #EF9A9A",textAlign:"center"}}><div style={{fontWeight:700,color:"#c62828"}}>{aiError}</div><Btn onClick={()=>buildPassage(selLevel)} color="#e53935" style={{marginTop:10,padding:"8px 20px",fontSize:12}}>🔄 Try Again</Btn></div>}
        ...
        {!aiLoading&&!aiError&&tokens.length>0&&(<>
          ...
          <div style={{background:"#fff",borderRadius:14,padding:"12px 16px",marginBottom:16,boxShadow:"0 2px 10px rgba(0,0,0,.07)",maxHeight:160,overflowY:"auto"}}>
            ...
            <div className="hin" style={{fontSize:14,color:"#555",lineHeight:2.2}}>
              {["lv1","lv2","lv3"].includes(selLevel)?tokens.join("  ·  "):tokens.join(" ")}
            </div>
          </div>

          {/* ═══════════════════════════════════════════════════
              MICROPHONE PERMISSION CARD
              Step 1 — must do this BEFORE starting the test
          ═══════════════════════════════════════════════════ */}
          <div style={{borderRadius:18,overflow:"hidden",
            ...
            <div style={{
              ...
              <div style={{fontSize:30,flexShrink:0}}>
                {micStep==="granted"?"✅":micStep==="denied"?"🚫":micStep==="asking"?"⏳":"🎤"}
              </div>
              <div>
                <div style={{color:"#fff",fontWeight:900,fontSize:16}}>
                  {micStep==="granted"?"Microphone is ON ✓":
            ...
            <div style={{background:"#fff",padding:"16px 18px"}}>
              ...
              {(micStep==="idle")&&(
                <>
                  <div style={{fontSize:12,color:"#444",lineHeight:1.8,marginBottom:14}}>
                    ...
                    <div style={{marginTop:10,fontWeight:700,color:"#E65100"}}>→ Tap <strong>"Allow"</strong> in that popup!</div>
                  </div>
                  <button onClick={handleAllowMic} disabled={micBusy}
                    ...
                    {micBusy
                      ?<><span className="spin" style={{display:"inline-block"}}>⏳</span> Requesting...</>
                      :<><span style={{fontSize:20}}>🎤</span> Allow Microphone</>}
                  </button>
                </>
              )}
              ...
              {micStep==="denied"&&(
                <>
                  <div style={{background:"#FFEBEE",borderRadius:10,padding:"12px",fontSize:12,color:"#c62828",lineHeight:1.8,marginBottom:12}}>
                    ...
                    1. Click the 🔒 <strong>lock icon</strong> in the browser address bar<br/>
                    2. Find <strong>"Microphone"</strong> → set to <strong>"Allow"</strong><br/>
              ...
              {micStep==="unsupported"&&(
                <div style={{background:"#FFF3E0",borderRadius:10,padding:"12px",fontSize:12,color:"#E65100",lineHeight:1.7}}>
                  ⚠️ Recording requires <strong>Google Chrome</strong> on Android or Desktop.<br/>
                  The reading test works without recording — tap Start below.
                </div>
              )}
            </div>
          </div>
          ...
          <button onClick={startTest}
            style={{width:"100%",padding:"17px",borderRadius:16,border:"none",
              ...
              transition:"all .2s"}}>
            {micStep==="granted"?"🚀 START READING TEST":"▶ Start Without Recording"}
          </button>
        </>)}
      </div>
    </div>
    ...
    <div style={{minHeight:"calc(100vh - 56px)",background:"#FFF9F0",paddingBottom:90,paddingTop:8}}>
      <div style={{padding:"0 16px"}}>
        ...
        <div style={{background:`linear-gradient(135deg,${meta.color},${meta.color}cc)`,
          ...
          {[["⏱️",timeStr,"Time"],["✅",tapped.size,"Tapped"],
            ["📖",tokens.length-tapped.size,"Left"],["💯",pctDone+"%","Done"]].map(([ic,v,l],i,arr)=>(
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:7}}>
              {tokens.map((tok,i)=>{const done=tapped.has(i);return(
                <div key={i} onClick={()=>tapToken(i)} style={{background:done?meta.color:"#f7f7f7",
                  ...
                  {done&&<div style={{fontSize:9,color:"rgba(255,255,255,.85)"}}>✓</div>}
                </div>
              );})}
            </div>
          </div>
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:9}}>
              {tokens.map((tok,i)=>{const done=tapped.has(i);return(
                <div key={i} onClick={()=>tapToken(i)} style={{background:done?meta.color:"#f7f7f7",
                  ...
                  transition:"all .12s",userSelect:"none"}}>
                  <div className="hin" style={{fontSize:21,fontWeight:900,color:done?"#fff":"#333"}}>{done?"✓ ":""}{tok}</div>
                </div>
              );})}
            </div>
          </div>
        ...
        <div style={{textAlign:"center",fontSize:11,color:"#999",marginBottom:12}}>
          👆 Tap each {selLevel==="lv1"?"letter":"word"} as you read it aloud
        </div>
      ...
      <div className="fade-up" style={{minHeight:"calc(100vh - 56px)",background:"#FFF9F0",paddingBottom:90,paddingTop:8}}>
        <div style={{padding:"0 20px"}}>
          ...
          <div style={{background:`linear-gradient(135deg,${meta.color},${meta.color}99)`,
            ...
            <div style={{fontSize:12,opacity:.85}}>{meta.icon} {meta.label} · {passTitle}</div>
            <div style={{background:"rgba(255,255,255,.2)",borderRadius:18,padding:"14px 20px",marginTop:14,marginBottom:12}}>
              ...
              {target>0&&<div style={{fontSize:11,opacity:.8,marginTop:3}}>Target: {target} {unit} · {wpm>=target?"✅ Achieved!":target-wpm+" more to go"}</div>}
            </div>
            ...
            {passMoral&&<div style={{background:"rgba(255,255,255,.2)",borderRadius:12,padding:"8px 14px",marginBottom:10,fontSize:11}}><span className="hin">💡 {passMoral}</span></div>}
            {selLevel==="c2"&&<div style={{fontSize:10,opacity:.8}}>Stories: {storyHist.count} · Next: difficulty {storyHist.difficulty}/10</div>}
            <div style={{fontSize:11,opacity:.85,marginTop:6}}>+{ptsEarned} pts · {tapped.size}/{tokens.length} words</div>
          </div>

          {/* Stats row */}
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10,marginBottom:16}}>
            {[["⏱️",timeStr,"Time"],["✅",tapped.size,"Read"],["🏆",prevBest[selLevel]||wpm,"Best"]].map(([ic,v,l])=>(
          ...
          <div style={{marginBottom:16}}>
            <div style={{fontWeight:800,fontSize:14,color:"#333",marginBottom:10,display:"flex",alignItems:"center",gap:8}}>
              <span style={{fontSize:22}}>🎧</span> Listen to Your Reading
            </div>
            {audioURL?(
              <>
                ...
                <div style={{marginTop:8,background:"#E8F5E9",borderRadius:10,padding:"9px 13px",fontSize:11,color:"#2e7d32",fontWeight:600}}>
                  💡 Tap ▶ to hear your voice! Notice your pronunciation and pace.
                </div>
              </>
            ):(
                ...
                <div>
                  <div style={{fontSize:12,fontWeight:700,color:"#F57F17"}}>
                    {micStep==="denied"||micStep==="unsupported"
                      ?"Recording not available — mic was not enabled"
          ...
          {meta.wpmTarget>0&&(
            <div style={{background:"#fff",borderRadius:16,padding:"13px 16px",marginBottom:14,boxShadow:"0 2px 10px rgba(0,0,0,.06)"}}>
              <div style={{fontWeight:700,fontSize:12,color:"#555",marginBottom:8}}>📊 Grading Scale (Target: {meta.wpmTarget} WPM)</div>
              {[["A+",`${Math.round(meta.wpmTarget*1.1)}+ WPM`,"#43A047"],
                ["A", `${Math.round(meta.wpmTarget*.9)}–${Math.round(meta.wpmTarget*1.1)-1} WPM`,"#43A047"],
                ["B+",`${Math.round(meta.wpmTarget*.75)}–${Math.round(meta.wpmTarget*.9)-1} WPM`,"#1E88E5"],
                ["B", `${Math.round(meta.wpmTarget*.6)}–${Math.round(meta.wpmTarget*.75)-1} WPM`,"#1E88E5"],
                ["C", `${Math.round(meta.wpmTarget*.4)}–${Math.round(meta.wpmTarget*.6)-1} WPM`,"#FB8C00"],
                ...
                return(<div key={g} style={{display:"flex",alignItems:"center",gap:10,
                  ...
                  {mine&&<div style={{fontSize:14}}>← You</div>}
                </div>);
              })}
            </div>
          )}
          ...
          <div style={{display:"flex",gap:10,marginBottom:10}}>
            <Btn onClick={tryAgain} color={meta.color} style={{flex:1,padding:14}}>🔄 New Passage</Btn>
            <Btn onClick={()=>setPhase("select")} color="#555" style={{flex:1,padding:14}}>📋 All Levels</Btn>
          </div>
          {selLevel!=="c2"&&(
            <Btn onClick={async()=>{
            ...
            }} color="#8E24AA" style={{width:"100%",padding:13}}>⬆️ Try Next Level</Btn>
          )}
        </div>
      </div>
    );
...
export default function App() {
  ...
  // ── Persist user changes (points, wpm etc.) back to DB ──
  const updateUser = (u) => {
    setUser(u);
    if (u && u.email) dbUpdateUser(u.email, u);
  };

  // ── Show nothing until session check is done ──
  if (!authReady) return (
  ...
  // ── GATE: if not logged in, always show AuthScreen ──
  if (!user) return (
